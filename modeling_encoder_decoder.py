...
from transformers import PretrainedConfig, PreTrainedModel, EncoderDecoderConfig
        ...
        **kwargs
        ...
        if encoder is None:
            ...
            if "config" not in kwargs_encoder:
                ...
                encoder_config = GPT2Config.from_pretrained(encoder_pretrained_model_name_or_path)
            ...
            encoder = GPT2Model.from_pretrained(encoder_pretrained_model_name_or_path)

            # convert all attention bias to 1
            bias = encoder.h[0].attn.bias
            for i in range(len(encoder.h)):
                encoder.h[i].attn.bias = bias.new_ones(bias.shape, dtype=torch.long).to(bias.device)
        ...
        if decoder is None:
            ...
            if "config" not in kwargs_decoder:
                ...
                decoder_config = GPT2Config.from_pretrained(decoder_pretrained_model_name_or_path)
            ...
            decoder = GPT2LMHeadModel.from_pretrained(decoder_pretrained_model_name_or_path, decoder_config)
